...
const poles = [
  ...
  },
  {
    ...
    categorie: "tech",
    logo: "../../photo/logo-pole-telecom.png",
  ...
  },
  {
    ...
    categorie: "finance",
    logo: "../../photo/logo-pole-finance.png",
  ...
  },
  {
    ...
    categorie: "commerce",
    logo: "../../photo/logo-pole-commerce.png",
  ...
  {
    id: "infra",
    titre: "Pôle Infrastructures & Mobilités",
    couleur: "#854F0B",
    couleurPastel: "rgba(133, 79, 11, 0.08)",
    categorie: "infrastructure",
    logo: "../../photo/logo-pole-immobilier.png",
  ...
  {
    id: "immobilier",
    titre: "Pôle Immobilier",
    couleur: "#533AB7",
    couleurPastel: "rgba(83, 58, 183, 0.08)",
    categorie: "infrastructure",
    logo: "../../photo/logo-pole-international.png",
    date: "Croissance et projets urbains",
    directeur: {
      nom: "Sophie Lachaud",
      role: "Directrice Générale Immobilier",
      init: "SL",
    },
    kpiMain: { valeur: "40+", label: "Projets actifs" },
    desc: "Le pôle immobilier développe et gère des projets urbains liés à l’expansion économique du groupe.",
    metrics: [
      { val: "40+", lab: "pays" },
      { val: "2", lab: "filiales" },
    ],
    filiales: [
      ...
      "Développement de quartiers d’affaires",
      "Gestion d’actifs immobiliers",
    ],
    tags: ["Immobilier", "Bureaux", "Expansion"],
  ...
  },
  {
    ...
    categorie: "tech",
    logo: "../../photo/logo-pole-france.png",
